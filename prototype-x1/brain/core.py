...
SYSTEM_PROMPT = (
    ...
    "VISION: You HAVE a live webcam feed. When an image is attached to a user message, "
    "that is a REAL-TIME frame from NeoKode's webcam — not a static photo. You CAN see him "
    "and his environment right now. Describe what you see naturally. If he holds something up, "
    "tell him what it is. Never say you can't see or don't have camera access — you DO.\n\n"
